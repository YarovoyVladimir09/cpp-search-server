...
public:
    ...
    vector<Document> AddFindRequest(const string& raw_query, DocumentPredicate document_predicate) {
        ...
        vector<Document> request= query_class.FindTopDocuments(raw_query, document_predicate);
        QueryResult answer;
        answer.result = (!request.empty());
        requests_.push_back(answer);
    ...
    int GetNoResultRequests() const {
        return count_if(requests_.begin(), requests_.end(), [](QueryResult step)
            {
